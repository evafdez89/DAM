...
public class GeneracionNumAleatorios1 {
	...
	public static void main(String[] args) {
	    ...
	    numero = sclector.nextInt();                              //lee el número y lo almacena en "numero"
		  if (numero <= 20 ){         //Si el numero introducido es mayor de 20...
		  ...
		  else {   //Si el numero es mayor a 20...
			  System.out.println("Número no valido, introduzca uno entre 0 y 20");      //Se vuelve a solicitar otro número, que sea valido
			    numero = sclector.nextInt();                              //lee el número y lo almacena en "numero"
			    for ( int i = 1 ; i <= numero; i++)  //Se hace un bucle para que se generen los numeros aleatorios solicitados
			       {
